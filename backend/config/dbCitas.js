...
const urlweb = 'mongodb+srv://medi:i6BY5XEuevPIVyNH@medi.vknwb.mongodb.net/MediCitas?retryWrites=true&w=majority&appName=MEDI'
...
try {
  ...
  console.log("MongoDb corriendo MEDICITAS");
} catch (error) {
  console.error();
}
